...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <h2 className="section-title text-sm md:text-base border-b border-accent-text border-opacity-30 pb-2 flex-shrink-0">
        Atelier Collection
      </h2>

      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3 flex-1 overflow-y-auto mt-3">
        {wardrobe.map((item) => {
